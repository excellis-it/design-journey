...
@section('title')
    Free Illustration Edit - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
...
@section('content')
    <section class="section_breadcrumb d-block d-sm-flex justify-content-between">
        <div class="">
            <h4 class="page-title m-b-0">Edit Free Illustration Category</h4>
        ...
        <div class="inner_page">
            ...
            <div class="card search_bar sales-report-card">
                <div class="sales-report-card-wrap">
                    ...
                    <form action="{{ route('update.free-illustrations') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row justify-content-between">

                            <input type="hidden" name="id" value="{{ $illustration_category->id }}" >
                            <div class="col-md-6">
                                <div class="form-group-div">
                                    <div class="form-group">
                                        <label for="floatingInputValue"> Category*</label>
                                        <input type="text" name="illustration_category" class="form-control"
                                            id="floatingInputValue" placeholder="Enter category*"
                                            value="{{ $illustration_category->category_name }}">
                                        @if ($errors->has('illustration_category'))
                                            <div class="error" style="color:red;">
                                                {{ $errors->first('illustration_category') }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category_slug" class="form-control"
                                            ...
                                            value="{{ $illustration_category->category_slug }}">
