...
@section('content')
    <section class="section_breadcrumb d-block d-sm-flex justify-content-between">
        <div class="">
            <h4 class="page-title m-b-0">Illustration Category List</h4>
        </div>
        <div class="">
                    ...
                    <table class="table table-bordered" id="myTable" class="display">
                        ...
                        <tbody>
                            @foreach ($free_illustrations as $free_illustration)
                                <tr>
                                    <td>{{ $free_illustration->category_name }}</td>
                                    <td>{{ $free_illustration->category_slug }}</td>
                                    <td>
                                        <div class="edit-1 d-flex align-items-center">
                                        <a href="{{ route('free-illustrations.edit', $free_illustration->id) }}"> <span class="edit-icon"><i
                                                    class="ph ph-pencil-simple"></i></span></a>
                                        <a title="Delete Blog" data-route="{{ route('delete.free-illustrations',$free_illustration->id) }}"
