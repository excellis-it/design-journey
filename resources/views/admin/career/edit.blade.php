        ...
        <div class="inner_page">
            ...
            <div class="card search_bar sales-report-card">
                <div class="sales-report-card-wrap">
                    ...
                    <form action="{{ route('update.careers') }}" method="post" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="career_name" class="form-control" id="floatingInputValue"
                                            placeholder="Enter name*" value="{{ $career->career_name }}">
                                ...
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" class="form-control" id="floatingInputValue"
                                            placeholder="Enter location*" value="{{ $career->location }}">
                                    ...
                                    <div class="form-group-div">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="work_type" class="form-control" id="floatingInputValue"
                                                placeholder="Enter Work type*" value="{{ $career->work_type }}">
                                ...
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <textarea name="details" class="form-control" id="editor1"
                                            placeholder="Enter details*" >{{ $career->details }}</textarea>
