...
@section('content')
    <section class="section_breadcrumb d-block d-sm-flex justify-content-between">
        <div class="">
            <h4 class="page-title m-b-0">Create Free Icon Category</h4>
        ...
        <div class="">
            <ul class="breadcrumb breadcrumb-style">
                ...
                <li class=""> >>  Free Icon Category</li>
            </ul>
        </div>
    </section>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="icon_category" class="form-control" id="floatingInputValue"
                                            placeholder="Enter category*" value="{{ old('icon_category') }}">
