...
@section('title')
    Extension Image Edit - {{ env('APP_NAME') }}
@endsection
@push('styles')
@endpush
        ...
        <div class="inner_page">
            ...
            <div class="card search_bar sales-report-card">
                <div class="sales-report-card-wrap">
                    ...
                    <form action="{{ route('update.extension-images') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row justify-content-between">

                            <input type="hidden" value="{{ $edit_extension->id }}" name="extension_id">
                            <div class="col-md-6">
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="extension" class="form-control" id="floatingInputValue"
                                            placeholder="Enter extension*" value="{{ $edit_extension->extension }}">
                                ...
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="floatingInputValue"
                                            placeholder="Enter name*" value="{{ $edit_extension->name }}">
                                        @if ($errors->has('name'))
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group-div">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ Storage::url($edit_extension->image) }}" style="width:180px;hight:100px;">
