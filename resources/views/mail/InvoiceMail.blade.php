                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><span
                                                                    ...
                                                                    justify-content: space-between;font-family: Montserrat, sans-serif;">
                                                                        <span>{{ $maildata['invoice_detail']['type'] }}#</span> <span>DATE</span></span>
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td><span
                                                                        ...
                                                                        TERMS</span>
                                                                        <span style="color: #000; text-align: left; display: inline-block; width: 100%; font-size: 14px; font-weight: 400;font-family: Montserrat, sans-serif;">{{ $maildata['invoice_detail']['due'] }}</span>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <span
                                                        ...
                                                        To</span>
                                                    <span
                                                        style="display: block; text-align: left; padding-top: 5px;font-family: Montserrat, sans-serif;font-weight:400;">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                        ...
                        <tr bgcolor="#fff" style="text-align: center;">
                            <td height="50">
                                ...
                                <p style="color: #000; padding: 10px; margin: 0;font-style: italic; font-weight: 600;font-family: Montserrat, sans-serif;">
