...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1">
                        <div class="header-content t-center">
                            <h1 class="m-horz-auto heading-width-res-full heading-width-83"><span class="c-red">Social
                                    media</span> design service</h1>
                            <p class="paragraph-big m-horz-auto heading-width-res-full heading-width-65">Level up your social
                                media game with gorgeous graphics. Get everything you need with one affordable design
                                subscription.</p>
                ...
                <div class="row">
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-section-heading">
                            <h1 class="t-center m-horz-auto c-dark heading-width-res-full heading-width-100">Our latest
                                social media designs</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="feature-section" id="about">
        <div class="feature-section-wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1 wow fadeInUp"
                        data-wow-delay="0.2s">
                        <div class="feature-section-heading">
                            <h1 class="t-center m-horz-auto c-dark heading-width-res-full heading-width-67">Get your designs
                                done in 1-2 days, not weeks</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="features-wrapper min_height_33">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="heading">
                            <h1 class="lt-80 t-center m-horz-auto c-dark heading-width-res-full heading-width-100">
                                Unlimited design vs other solutions</h1>
                        </div>
                    </div>
                    <!-- content - end -->
                </div>
            ...
            <div class="container pricing-section-content">
                ...
                <div class="row">
                    <div class="col-lg-12 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1 wow fadeInUp"
                        data-wow-delay="0.4s">
                        <div class="heading">
                            <h1 class="lt-80 t-center m-horz-auto c-dark heading-width-res-full heading-width-67">A <span
                                    class="bg-gregg c-dark-blue border-rounded">design solution</span> you will love</h1>
                        </div>
                    </div>
                </div>
                <!-- heading - end -->
                                        ...
                                        <div class="testimonial-slide">
                                            ...
                                            <div class="image">
                                                <div class="image-inner">
                                                    <img src="{{ asset('frontend_assets/assets/images/testimonial-img.jpg') }}"
                                                        alt="testimonial">
                                            ...
                                            <!-- content - start -->
                                            <div class="content">
                                                <p class="c-white">It is a long established fact that a reader will be
            ...
            <div class="background-layout">
                <div class="box-1 bg-darkk">
                    <div class="box-1-1 bg-dark-1">
                        <div class="box-1-1-1 bg-dark-1 wow pulse" data-wow-delay="0.7s" data-wow-iteration="infinite">
                        </div>
                    </div>
                </div>
        ...
        <div class="faq-section-wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1">
                        <div class="heading">
                            <h1 class="lt-80 t-center m-horz-auto c-dark heading-width-res-full heading-width-67">Some
