                ...
                <div class="row">
                    <div class="col-lg-12 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1">
                        <div class="header-content t-center">
                            <h1 class="m-horz-auto heading-width-res-full heading-width-83"><span class="c-red">Illustration</span> design service</h1>
                            <p class="paragraph-big m-horz-auto heading-width-res-full heading-width-65">Customize your ads, socials, or landing pages with beautiful illustrations. Get as many you want with one flat-rate design subscription.</p>
                ...
                <div class="row">
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-section-heading">
                            <h1 class="t-center m-horz-auto c-dark heading-width-res-full heading-width-100">Our latest illustration designs</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1">
                        <div class="pattern-image">
                            ...
                            <div class="background-layout">
                                <div class="box-1 box-image" style="background-image: url('{{Storage::url($solutionCms->section1_image)}}');">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 offset-lg-0 order-lg-2 col-md-8 offset-md-2 col-10 offset-1 order-1">
                        <div class="pattern-image pattern-image-reverse">
                            ...
                            <div class="background-layout">
                                <div class="box-1 box-image" style="background-image: url('{{Storage::url($solutionCms->section2_image)}}');">
