                ...
                <div class="row">
                    <div class="col-lg-12 offset-lg-0 col-md-8 offset-md-2 col-10 offset-1">
                        <div class="header-content t-center">
                            <h1 class="m-horz-auto heading-width-res-full heading-width-83"><span class="c-red">Presentation</span> design service</h1>
                            <p class="paragraph-big m-horz-auto heading-width-res-full heading-width-65">Forget about sloppy DIY slide decks. Get professional presentations with our unlimited design subscription. Simple, affordable, fast.</p>
                ...
                <div class="row">
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-section-heading">
                            <h1 class="t-center m-horz-auto c-dark heading-width-res-full heading-width-100">Our latest presentations designs</h1>
                        </div>
                    </div>
                </div>
            </div>
