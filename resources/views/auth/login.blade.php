            ...
            <div class="form-content">
                <div class="login-form">
                    <div class="login-page-logo d-md-none d-block">
                        <a href="{{ url('/') }}"><img src="{{ asset('frontend_assets/img/invoice_logo1.png') }}"
                                alt=""></a>
                    </div>
                    ...
                    <form action="{{ route('login.check') }}" method="post">
                        ...
                        <div class="input-boxes">
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('forget.password.show') }}" class="forgot_pass"
                                    style="color: #007DD9; text-decoration: none;">Forgot Your
                                    Password?</a>
                            </div>
