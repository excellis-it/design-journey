...
class FreeIllustrationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.free_illustrations.index', compact('free_illustrations'));
    ...
    {
        //
        return view('admin.free_illustrations.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('free-illustrations.index')->with('success', 'Free Illustration Category Added Successfully');
    }
