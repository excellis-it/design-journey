    ...
    public function handleProviderCallback($provider)
    {
        ...
        try {
            ...
            if($finduser){
                ...
                $check_user_plan = Payment::where('user_id', $finduser->id)->first();
                if($check_user_plan){
                ...
                if($user->avatar != null)
                {
                    ...
                    Storage::put('public/users/'.$filename, $fileContents);
                    ...
                    return redirect()->route('pricing')->with('message', 'Login Successfully');
